...
while capture.isOpened():
    ...
    # create a binary image where white will be skin colors & rest is black
    ...
    ret, thresh = cv2.threshold(filtered,127,255,0) # 0 for binary conversion
    ...
    try:
        ...
        # Use cosine rule to find angle of far point from the start & end point i.e. the convex tips for all defect
        count_defects = 0
